...
test('should suggest databases or tables', () => {
    const parseResult = parseGenericSql('SELECT * FROM test_table GROUP ', '');
...
test('should suggest databases or tables', () => {
    const parseResult = parseGenericSql('SELECT * FROM test_table WHERE test_condition GROUP ', '');
...
test('should suggest databases or tables', () => {
    const parseResult = parseGenericSql("SELECT * FROM test_table WHERE id LIKE '' GROUP ", '');
...
test('should suggest databases or tables', () => {
    const parseResult = parseGenericSql('SELECT * FROM test_table GROUP BY ', '');
...
test('should suggest columns', () => {
    const parseResult = parseGenericSql('SELECT * FROM test_database.test_table GROUP BY ', '');
