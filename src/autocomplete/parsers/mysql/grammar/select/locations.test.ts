...
import {mysqlAutocompleteParser} from '../../mysqlAutocompleteParser';

beforeAll(() => {
    mysqlAutocompleteParser.yy.parseError = function (msg: string): void {
        throw Error(msg);
    };
});
...
test('should report locations for "SELECT * FROM testTable1 JOIN db1.table2; |"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('SELECT * FROM testTable1 JOIN db1.table2; ');
...
test('should report locations for "SELECT a.col FROM db.tbl a; |"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('SELECT a.col FROM db.tbl a; ');
...
test('should report locations for "SELECT tbl.col FROM db.tbl a; |"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('SELECT tbl.col FROM db.tbl a; ');
...
test('should report locations for "select x from x;"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('select x from x;');
...
test('should report locations for "select x from x;select y from y;"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('select x from x;select y from y;');
...
test('should report locations for "select x from x, y;"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('select x from x, y;');
...
test('should report locations for "SELECT * FROM foo WHERE bar IN (1+1, 2+2);|"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('SELECT * FROM foo WHERE bar IN (1+1, 2+2);');
...
test('should report locations for "SELECT COUNT(*) FROM testTable; |"', () => {
    const parseResult = parseMySqlQueryWithoutCursor('SELECT COUNT(*) FROM testTable;');
