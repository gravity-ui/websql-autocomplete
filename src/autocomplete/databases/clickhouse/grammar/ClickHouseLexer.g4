...
FORMAT_TAB_SEPARATED_WITH_NAMES                           : 'TabSeparatedWithNames';
FORMAT_TAB_SEPARATED_WITH_NAMES_AND_TYPES                 : 'TabSeparatedWithNamesAndTypes';
FORMAT_TAB_SEPARATED_RAW_WITH_NAMES                       : 'TabSeparatedRawWithNames';
FORMAT_TAB_SEPARATED_RAW_WITH_NAMES_AND_TYPES             : 'TabSeparatedRawWithNamesAndTypes';
FORMAT_TEMPLATE                                           : 'Template';
FORMAT_TEMPLATE_IGNORE_SPACES                             : 'TemplateIgnoreSpaces';
FORMAT_CSV                                                : 'CSV';
FORMAT_CSV_WITH_NAMES                                     : 'CSVWithNames';
FORMAT_CSV_WITH_NAMES_AND_TYPES                           : 'CSVWithNamesAndTypes';
FORMAT_CUSTOM_SEPARATED                                   : 'CustomSeparated';
FORMAT_CUSTOM_SEPARATED_WITH_NAMES                        : 'CustomSeparatedWithNames';
FORMAT_CUSTOM_SEPARATED_WITH_NAMES_AND_TYPES              : 'CustomSeparatedWithNamesAndTypes';
FORMAT_VALUES                                             : 'Values';
FORMAT_JSON                                               : 'JSON';
FORMAT_JSON_AS_STRING                                     : 'JSONAsString';
FORMAT_JSON_AS_OBJECT                                     : 'JSONAsObject';
FORMAT_JSON_STRINGS                                       : 'JSONStrings';
FORMAT_JSON_COLUMNS                                       : 'JSONColumns';
FORMAT_JSON_COLUMNS_WITH_METADATA                         : 'JSONColumnsWithMetadata';
FORMAT_JSON_COMPACT                                       : 'JSONCompact';
FORMAT_JSON_COMPACT_COLUMNS                               : 'JSONCompactColumns';
FORMAT_JSON_EACH_ROW                                      : 'JSONEachRow';
FORMAT_JSON_STRINGS_EACH_ROW                              : 'JSONStringsEachRow';
FORMAT_JSON_COMPACT_EACH_ROW                              : 'JSONCompactEachRow';
FORMAT_JSON_COMPACT_EACH_ROW_WITH_NAMES                   : 'JSONCompactEachRowWithNames';
FORMAT_JSON_COMPACT_EACH_ROW_WITH_NAMES_AND_TYPES         : 'JSONCompactEachRowWithNamesAndTypes';
FORMAT_JSON_COMPACT_STRINGS_EACH_ROW                      : 'JSONCompactStringsEachRow';
FORMAT_JSON_COMPACT_STRINGS_EACH_ROW_WITH_NAMES           : 'JSONCompactStringsEachRowWithNames';
FORMAT_JSON_COMPACT_STRINGS_EACH_ROW_WITH_NAMES_AND_TYPES : 'JSONCompactStringsEachRowWithNamesAndTypes';
FORMAT_JSON_OBJECT_EACH_ROW                               : 'JSONObjectEachRow';
FORMAT_BSON_EACH_ROW                                      : 'BSONEachRow';
FORMAT_TSKV                                               : 'TSKV';
FORMAT_PROTOBUF                                           : 'Protobuf';
FORMAT_PROTOBUF_SINGLE                                    : 'ProtobufSingle';
FORMAT_PROTOBUF_LIST                                      : 'ProtobufList';
FORMAT_AVRO                                               : 'Avro';
FORMAT_AVRO_CONFLUENT                                     : 'AvroConfluent';
FORMAT_PARQUET                                            : 'Parquet';
FORMAT_PARQUET_METADATA                                   : 'ParquetMetadata';
FORMAT_ARROW                                              : 'Arrow';
FORMAT_ARROW_STREAM                                       : 'ArrowStream';
FORMAT_ORC                                                : 'ORC';
FORMAT_ONE                                                : 'One';
FORMAT_NPY                                                : 'Npy';
FORMAT_ROW_BINARY                                         : 'RowBinary';
FORMAT_ROW_BINARY_WITH_NAMES                              : 'RowBinaryWithNames';
FORMAT_ROW_BINARY_WITH_NAMES_AND_TYPES                    : 'RowBinaryWithNamesAndTypes';
FORMAT_ROW_BINARY_WITH_DEFAULTS                           : 'RowBinaryWithDefaults';
FORMAT_NATIVE                                             : 'Native';
FORMAT_CAPN_PROTO                                         : 'CapnProto';
FORMAT_LINE_AS_STRING                                     : 'LineAsString';
FORMAT_REGEXP                                             : 'Regexp';
FORMAT_RAW_BLOB                                           : 'RawBLOB';
FORMAT_MSG_PACK                                           : 'MsgPack';
FORMAT_MYSQL_DUMP                                         : 'MySQLDump';
FORMAT_DWARF                                              : 'DWARF';
FORMAT_FORM                                               : 'Form';
