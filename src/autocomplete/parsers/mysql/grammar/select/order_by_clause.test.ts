...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table ORDER ', '');
...
test('should suggest columns', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table ORDER BY ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table ORDER BY test_column ', '');
...
test('should suggest columns', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table ORDER BY test_column ASC, ', '');
