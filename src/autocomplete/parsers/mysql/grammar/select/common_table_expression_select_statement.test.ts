...
test('should suggest alias', () => {
    const parseResult = parseMySqlQuery('WITH test_table ', '');
...
test('should suggest SELECT', () => {
    const parseResult = parseMySqlQuery('WITH test_table AS ( ', '');
...
test('should suggest SELECT', () => {
    const parseResult = parseMySqlQuery('WITH t AS (SELECT * FROM test_table) ', '');
...
test('should suggest columns', () => {
    const parseResult = parseMySqlQuery('WITH t AS (SELECT * FROM test_table) SELECT ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('WITH t AS (SELECT * FROM test_table) SELECT * FROM ', '');
