...
test('should suggest joins', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table JOIN ', '');
...
test('should suggest joins', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 JOIN test_table_2 JOIN ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table INNER ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table FULL ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 FULL OUTER ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 LEFT ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 LEFT OUTER ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 RIGHT ', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 RIGHT OUTER ', '');
...
test('should suggest tables', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 JOIN test_database.', '');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT t1.* FROM table1 t1 ', ' JOIN');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT t1.* FROM test_table_1 t1 FULL ', ' JOIN');
...
test('should suggest keywords', () => {
    const parseResult = parseMySqlQuery('SELECT t1.* FROM test_table_1 t1 RIGHT ', ' JOIN');
...
test('should suggest joins', () => {
    const parseResult = parseMySqlQuery('SELECT * FROM test_table_1 ', '');
