...
test('should suggest IF NOT EXISTS', () => {
    const parseResult = parseMySqlQuery('CREATE VIEW ', '');
...
test('should suggest AS and COMMENT', () => {
    const parseResult = parseMySqlQuery('CREATE VIEW test_view ', '');
...
test('should suggest SELECT', () => {
    const parseResult = parseMySqlQuery('CREATE VIEW test_view AS ', '');
