...
if [ "$DIALECT" == "mysql" ]
then
  FILE_PREFIX=src/lib/autocomplete/$DIALECT/generated/MySql
elif [ "$DIALECT" == "postgresql" ]
then
  FILE_PREFIX=src/lib/autocomplete/$DIALECT/generated/PostgreSql
else
  FILE_PREFIX=src/lib/autocomplete/$DIALECT/generated/ClickHouse
fi
