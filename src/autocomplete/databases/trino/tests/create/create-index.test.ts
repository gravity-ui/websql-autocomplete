...
test('should suggest properly after INDEX', () => {
    const autocompleteResult = parseTrinoQueryWithCursor('CREATE INDEX |');
...
test('should suggest properly after index name', () => {
    const autocompleteResult = parseTrinoQueryWithCursor('CREATE INDEX test_index |');
...
test('should suggest properly after ON', () => {
    const autocompleteResult = parseTrinoQueryWithCursor('CREATE INDEX test_index ON |');
